  ...
  <div class="content container">
    <form action="../proseskirim.php" method="post">
      ...
      <div class="mb-3">
        ...
        <textarea required name="content" class="form-control" id="content" rows="5"></textarea>
      </div>
      <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Author</span>
        <input required type="text" name="author" id="author" class="form-control" aria-describedby="basic-addon1">
      </div>
      <div class="mb-3">
